...
negativeArgs = ["Radschnellverbindung ist eine\nGefahr für die Fußgänger:innen","Die Barrierefreiheit der Straße\nkann darunter leiden","Das Fehlen von Parkplätzen"]
...
def printFlyer():
    ...
    printer.boldOff()
    printer.setSize('S')
    printer.print("Du scheinst noch unentschlossen zu sein. Hierbei ein Argument\ndafür und ein zweites dagegen:")
    ...
    printer.print("----------")
    printer.feed(2)  # Blank lines
    printer.print(random.choice(negativeArgs))
